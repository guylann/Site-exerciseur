var Titre = "Déterminer l'antécédent d'un nombre.";
var Consigne =  "Donner l'antécédent de la valeur indiquée en vous aidant des informations founies (graphique, expression littérale ou tableau de valeurs)."
...
var values;
        ...
        function Valider() {
            ...
            if (flo == values.x)
            {
                ...
                document.getElementById("TextReponse").innerHTML = values.x;
            }
        ...
        function Recommencer(){
            ...
            document.getElementById("valeurx").innerHTML = values.y;
        }
